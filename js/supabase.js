...
function mapSupabaseToGame(row) {
  return {
    ...
    matchStructure: row.match_structure,
    totalEnds: row.total_ends,
    endCount: row.total_ends,
    ...
    bowlsPerPlayer: row.bowls_per_player,
    playersPerTeam: row.players_per_team,
    numberOfSets: row.number_of_sets,
    endsPerSet: row.ends_per_set,
    tieBreakEnds: row.tie_break_ends,
...
function mapDeliveryToBowl(d) {
  return {
    ...
    hand: d.hand,
    position: d.position,
    scoreValue: d.score_value,
    score: d.score_value,
    resultCategory: d.result_category,
    direction: d.result_category,
    distanceCategory: d.distance_category,
    distanceInFeet: d.distance_in_feet,
    distance: d.distance_in_feet,
    scoreCategory: d.score_category,
    scoreDetail: d.score_detail,
    matLength: d.mat_length,
    jackLength: d.jack_length,
